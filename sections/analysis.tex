...
\begin{figure}[tb]
  ...
  \begin{subfigure}{.49\textwidth}
    ...
    \caption{Prediction with the exponential function $f(x)$;
      \begin{tabular}{lll}
        \text{ } & $N_0$ & $= 1.83 \pm 0.414$              \\
        \text{ } & $a$   & $= 0.41 \pm 9.48 \cdot 10^{-3}$ \\
        \text{ } & $m_0$ & $= 4.45 \pm 0.102$
      \end{tabular}
    }
  ...
  \begin{subfigure}{.49\textwidth}
    ...
    \caption{
      Prediction with the logarithmic function $g(x)$;
      \begin{tabular}{lll}
        \text{ } & $N_0$ & $= 0.95 \pm 0.78$              \\
        \text{ } & $a$   & $= 0.51 \pm 8.2 \cdot 10^{-4}$ \\
        \text{ } & $m_0$ & $= 2.23 \pm 0.154$
      \end{tabular}
    }
